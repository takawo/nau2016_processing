...
public class sketch_extra_unfoldmap3 extends PApplet {
...
public void setup() {
  ...
  map.zoomAndPanTo(areas.get(currentLocation-1).loc, 8);
...
class Area {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_extra_unfoldmap3" };
    if (passedArgs != null) {
