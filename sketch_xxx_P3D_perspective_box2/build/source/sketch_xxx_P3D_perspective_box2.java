...
public class sketch_xxx_P3D_perspective_box2 extends PApplet {
...
class Form {
  ...
  int res = PApplet.parseInt(map(resSeed,0,1,8,0));
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_xxx_P3D_perspective_box2" };
    if (passedArgs != null) {
